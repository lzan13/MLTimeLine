package com.vmloft.develop.app.timeline.common.router;

import android.app.Activity;
import android.content.Context;
import android.content.Intent;
import android.os.Parcelable;
import com.vmloft.develop.app.timeline.account.AccountActivity;
import com.vmloft.develop.app.timeline.common.C;
import com.vmloft.develop.app.timeline.home.MainActivity;
import com.vmloft.develop.app.timeline.moment.MomentCreateActivity;
import com.vmloft.develop.app.timeline.sign.SignActivity;
...
public class NavRouter {
     ...
     * 创建
     */
    public static void goNoteCreate(Context context) {
        overlay(context, MomentCreateActivity.class);
    }
     ...
     * @param target 目标界面
     */
    private static void overlay(Context context, Class<? extends Activity> target, Parcelable parcelable) {
        Intent intent = new Intent(context, target);
     ...
     * @param target 目标界面
     */
    private static void overlay(Context context, Class<? extends Activity> target, int flags, Parcelable parcelable) {
        Intent intent = new Intent(context, target);
        putParcelableExtra(intent, parcelable);
        context.startActivity(intent);
        context = null;
     ...
     * @param target 目标
     */
    private static void forward(Context context, Class<? extends Activity> target, Parcelable parcelable) {
        Intent intent = new Intent(context, target);
        putParcelableExtra(intent, parcelable);
        context.startActivity(intent);
        if (isActivity(context)) {
     ...
     * @param flags 条件
     */
    private static void forward(Context context, Class<? extends Activity> target, int flags, Parcelable parcelable) {
        Intent intent = new Intent(context, target);
        setFlags(intent, flags);
        putParcelableExtra(intent, parcelable);
        context.startActivity(intent);
